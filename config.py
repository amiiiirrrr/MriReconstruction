...
config.TRAIN.beta1 = 0.9  # beta1 in Adam optimiser
...
config.TRAIN.epsilon = 0.00001


config.TRAIN.VGG16_path = os.path.join('trained_model', 'VGG16', 'vgg16_weights.zip')
...
config.TRAIN.mask_Radial2D_path = os.path.join('mask', 'Radial2D')
